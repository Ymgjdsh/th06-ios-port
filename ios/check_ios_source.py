...
def main() -> int:
    ...
    markers = (
        ...
        ("Endless density cap", endless, "kBulletSoftCap = 520"),
        ...
        ("Endless graze score isolation", read("src/Player.cpp"), "!EndlessMode::IsActive()"),
        ("Endless result screen", result, "ENDLESS RESULT"),
